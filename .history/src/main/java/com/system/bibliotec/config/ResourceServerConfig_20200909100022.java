	...
	public void configure(HttpSecurity http) throws Exception {
		http.csrf()
				...
				.authorizeRequests()
					...
					.antMatchers(HttpMethod.GET, ROOT_PATTERN_SWAGGER).access("#oauth2.hasScope('read')")
					.antMatchers(HttpMethod.POST, ROOT_PATTERN_SWAGGER).access("#oauth2.hasScope('write')")
					.antMatchers(HttpMethod.PATCH, ROOT_PATTERN_SWAGGER).access("#oauth2.hasScope('write')")
					.antMatchers(HttpMethod.PUT, ROOT_PATTERN_SWAGGER).access("#oauth2.hasScope('write')")
					.antMatchers(HttpMethod.DELETE, ROOT_PATTERN_SWAGGER).access("#oauth2.hasScope('write')")

					.antMatchers(HttpMethod.GET, ROOT_PATTERN_API_DOCS).access("#oauth2.hasScope('read')")
					.antMatchers(HttpMethod.POST, ROOT_PATTERN_API_DOCS).access("#oauth2.hasScope('write')")
					.antMatchers(HttpMethod.PATCH, ROOT_PATTERN_API_DOCS).access("#oauth2.hasScope('write')")
					.antMatchers(HttpMethod.PUT, ROOT_PATTERN_API_DOCS).access("#oauth2.hasScope('write')")
					.antMatchers(HttpMethod.DELETE, ROOT_PATTERN_API_DOCS).access("#oauth2.hasScope('write')")
