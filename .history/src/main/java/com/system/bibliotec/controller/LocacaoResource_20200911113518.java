...
import com.system.bibliotec.repository.filter.LocacaoFilter.LocacaoFilterBuilder;
...
public class LocacaoResource {
	...
	@PreAuthorize("hasAnyRole('ROLE_PESQUISAR_LOCACAO', 'ROLE_USER_ANONIMO','ROLE_ADMIN', 'ROLE_USER_SYSTEM') and #oauth2.hasScope('read')")
