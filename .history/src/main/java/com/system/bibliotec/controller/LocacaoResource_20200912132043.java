...
public class LocacaoResource {
	...
	public ResponseEntity<LocacaoVM> create(@Valid @RequestBody DespachoSolicitacaoLocacaoDTO locacaoDTO, HttpServletResponse response) {
		LocacaoVM locacaoSalva = locacaoService.atenderLocacao(locacaoDTO);
