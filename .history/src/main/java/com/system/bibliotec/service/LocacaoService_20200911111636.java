...
public class LocacaoService {
	...
	Specification<Locacoes> filtro = Specification.where(LocacaoSpecification.porID(filter.getIdLocacao())
		...
		.and(LocacaoSpecification.porIntervaloHoraCancelamento(filter.getHoraLocacaoInicio(), filter.getHoraLocacaoFim()))
		.and(LocacaoSpecification.porReparadora(idRep)).and(LocacaoSpecification.porAuditor(idAuditor))
		.and(LocacaoSpecification.porEmpresa(idEmpresa)).and(LocacaoSpecification.porStatus(status))
		.and(LocacaoSpecification.porLote(lote));
