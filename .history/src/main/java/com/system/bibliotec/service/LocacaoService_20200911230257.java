...
public class LocacaoService {
	...
	public List<LocacaoVM> filterQueryAnonymousUser(LocacaoFilter filter) {
		...
		.and(LocacaoSpecification.porUsuarioContexto(filter.getCreatedBy()))  // user anonymous online
	...
	public List<LocacaoVM> filterQueryAtendimento(LocacaoFilter filter) {
