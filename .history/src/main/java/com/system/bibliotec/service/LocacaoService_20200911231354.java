...
public class LocacaoService {
	...
	public List<LocacaoVM> filterQueryAnonymousUser(LocacaoFilter filter) {
		...
		.and(LocacaoSpecification.porUsuarioContexto(filter.getCreatedBy()))  // valor definido no construtor de LocacaoFilter conforme regra de negocio por endpoint de consulta
