...
public class OperacaoLocacaoImpl implements IOperacaoLocacao {
	...
	private final SolicitacaoService solicitacaoRepository;
	...
	public OperacaoLocacaoImpl(IvalidaUsuarioTriagemInicial validaUsuarioPessoa,
			...
			MapeadorLocacao mapper, ReservaRepository reservaRepository, SolicitacaoRepository solicitacaoRepository) {
	...
	public LocacaoVM realizarLocacao(LocacaoDTO dto) {
		...
		//Solicitacoes solicitacaoUsuario = solicitacaoRepository.findById(dto.getIdSolicitacao());
