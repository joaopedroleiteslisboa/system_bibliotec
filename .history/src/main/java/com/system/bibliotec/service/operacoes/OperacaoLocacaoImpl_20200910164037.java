...
public class OperacaoLocacaoImpl implements IOperacaoLocacao {
	...
	public LocacaoVM realizarLocacao(LocacaoDTO dto) {
		...
		solicitacaoService.updateStatusAndDescricao(Status.RECUSADA, dto.getIdSolicitacao(), ex.getMessage());
		throw new OperationCancelledException("Operação não permitida. Foi detectado inconsistência em seus dados. "+ ex.getMessage())
		}
