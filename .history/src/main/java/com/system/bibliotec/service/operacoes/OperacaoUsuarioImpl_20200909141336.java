...
public class OperacaoUsuarioImpl implements IOperacaoUsuario {
	...
	public Usuario findById(Long id) {
		...
		return userRepository.findById(id).orElseThrow((Supplier<? extends X>) () -> {

			new UsuarioNaoEncontrado("Proposta invalida. Cliente informado não localizado na Base de dados");
		});
