...
public class OperacaoUsuarioImpl implements IOperacaoUsuario {
	...
	@Override
	public Usuario findOneByEmailOrUsername(String email) {

		return userRepository.findOneByEmail(email)
		.or(() -> new AccountResourceException("Solicitação invalida. Usuario não encontrado na base de dados do Sistema"));
