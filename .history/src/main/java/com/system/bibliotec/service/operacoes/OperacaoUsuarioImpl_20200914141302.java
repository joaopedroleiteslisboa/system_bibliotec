...
public class OperacaoUsuarioImpl implements IOperacaoUsuario {
	...
	public Usuario findOneByEmailOrUsername(String emailOrUsername) {
		...
		return userRepository.findOneByEmail(emailOrUsername).orElseGet(()->	userRepository.findOneByUserName(emailOrUsername).orElseThrow(	() -> new UsuarioNaoEncontrado("Usuario não encontrado em nosso Banco de dados"))));
