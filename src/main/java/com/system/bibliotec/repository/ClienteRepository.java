...
import com.system.bibliotec.repository.cliente.FindOneByCpfQuery;

@Repository
public interface ClienteRepository extends PagingAndSortingRepository<Cliente, Long>, ClienteRepositoryQuery, FindOneByCpfQuery{
