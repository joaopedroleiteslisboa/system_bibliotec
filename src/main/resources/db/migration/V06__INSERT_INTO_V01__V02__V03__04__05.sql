	...
	INSERT INTO reservas(statusReserva, horaReserva, dataReserva, dataLimite, idCliente, idLivro) VALUES ('ATIVA', '19:00:00','2019-05-26','2019-05-28',1000,1001);
	
	INSERT INTO reservas(statusReserva, horaReserva, dataReserva, dataLimite, idCliente, idLivro) VALUES ('ATIVA', '19:05:00','2019-05-26','2019-05-28',1001,1000);
	
	-- insert locacoes
	
		
	INSERT INTO locacoes(statusLocacao, quantidadeDeRenovacao, horaLocacao, dataLocacao, dataTerminoLocacao, horaCancelamentoLocacao, dataCancelamentoLocacao, idCliente, idLivro) values ('ATIVA', 1,'19:09:32','2019-04-26','2019-05-06',NULL,NULL ,1003,1003);
	
	INSERT INTO locacoes(statusLocacao, quantidadeDeRenovacao, horaLocacao, dataLocacao, dataTerminoLocacao, horaCancelamentoLocacao, dataCancelamentoLocacao, idCliente, idLivro) values ('ATIVA', 1, '19:15:11','2019-04-26','2019-05-06',NULL,NULL,1004,1004);
