	...
	INSERT INTO clientes(statusCliente, nome, sobreNome, genero, cpf, dataNascimento, tipoCliente,  celular, telefoneResidencial, email_1, email_2, idEndereco)VALUES ('ATIVO', 'João Pedro Leite Soares Lisboa', 'Leite Soares', 'MASCULINO', '09104537483', '1996-03-10', 'FISICA',   '83999630573', '8332280775', 'joaopedroleite.s.lisboa@outlook.com', 'joaopedroleite.s.lisboa.info@gmail.com', 1000);
	
	INSERT INTO clientes(statusCliente, nome, sobreNome, genero, cpf, dataNascimento, tipoCliente,  celular, telefoneResidencial, email_1, email_2, idEndereco)VALUES ('ATIVO', 'Benjamim Gonçalves Soares', 'Gonçalves',  'MASCULINO', '45188013932', '2001-10-04', 'JURIDICA',   '83999638364', '8332283456', 'benjamim@outlook.com', 'benjamim@gmail.com', 1001);
	
	INSERT INTO clientes(statusCliente, nome, sobreNome, genero, cpf, dataNascimento, tipoCliente,  celular, telefoneResidencial, email_1, email_2, idEndereco)VALUES ('ATIVO', 'Patricia Ferreira Lima', 'Ferreira', 'FEMININO', '87769972000', '1993-10-03', 'JURIDICA',   '83999637843', '8332282345', 'patriciaferreiralima@outlook.com', 'patriciaferreiralima@gmail.com', 1002);
	
	INSERT INTO clientes(statusCliente, nome, sobreNome, genero, cpf, dataNascimento, tipoCliente,  celular, telefoneResidencial, email_1, email_2, idEndereco)VALUES ('ATIVO', 'Bianca cardoso', 'Cardoso',  'FEMININO', '03317970200', '1992-10-03', 'FISICA',   '83999633543', '8332287887', 'biancacardoso@outlook.com', 'biancacardoso@gmail.com', 1003);
	
	INSERT INTO clientes(statusCliente, nome, sobreNome, genero, cpf, dataNascimento, tipoCliente,  celular, telefoneResidencial, email_1, email_2, idEndereco)VALUES ('ATIVO', 'Ze lezin', 'Cardoso',  'MASCULINO', '06615286424', '1992-10-03', 'FISICA',   '83999633543', '8332287887', 'biancacardoso@outlook.com', 'biancacardoso@gmail.com', 1004);
	
	INSERT INTO clientes(statusCliente, nome, sobreNome, genero, cpf, dataNascimento, tipoCliente,  celular, telefoneResidencial, email_1, email_2, idEndereco)VALUES ('ATIVO', 'Fabiana', 'Soares',  'FEMININO', '74449085914', '1992-10-03', 'FISICA',   '83999633543', '8332287887', 'biancacardoso@outlook.com', 'biancacardoso@gmail.com', 1005);
	
	INSERT INTO clientes(statusCliente, nome, sobreNome, genero, cpf, dataNascimento, tipoCliente,  celular, telefoneResidencial, email_1, email_2, idEndereco)VALUES ('ATIVO', 'Ze ', 'Cardoso', 'MASCULINO', '43506004506', '1992-10-03', 'FISICA',   '83999633543', '8332287887', 'biancacardoso@outlook.com', 'biancacardoso@gmail.com', 1006);
	
	INSERT INTO clientes(statusCliente, nome, sobreNome, genero, cpf, dataNascimento, tipoCliente,  celular, telefoneResidencial, email_1, email_2, idEndereco)VALUES ('ATIVO', 'Lezin', 'Feitosa', 'MASCULINO', '77353603470', '1992-10-03', 'FISICA',   '83999633543', '8332287887', 'biancacardoso@outlook.com', 'biancacardoso@gmail.com', 1007);
